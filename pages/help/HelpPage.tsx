...
const HelpPage: React.FC = () => {
  ...
  const [userRole, setUserRole] = React.useState<UserRole>('visitor');
  const [userName, setUserName] = React.useState('Pengunjung');
  const [currentPageName, setCurrentPageName] = React.useState<PageName>('help');

// Prevent static prerendering; render this page on each request to avoid build-time data assumptions
...
const CheckoutPage: React.FC<CheckoutPageProps> = ({ checkoutInfo, eventForBackNav, onNavigate, onProcessPayment, isLoggedIn, loggedInUserData, onOpenLoginModal }) => {
